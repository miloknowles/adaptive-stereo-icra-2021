...
def write_lines():
  ...
  for subsplit in ["training", "testing"]:
    with open("train_lines.txt" if subsplit == "training" else "test_lines.txt", "w") as f:
      for i in range(200):
        rgb_l = "{}/image_2/{:06d}_10.png".format(subsplit, i)
        rgb_r = "{}/image_3/{:06d}_10.png".format(subsplit, i)
        disp_l = "{}/disp_occ_0/{:06d}_10.png".format(subsplit, i)
        disp_r = "{}/disp_occ_1/{:06d}_10.png".format(subsplit, i)
